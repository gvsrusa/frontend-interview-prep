...
function searchArticles(query: string): Promise<Article[]> {
...
export default function WikipediaSearch() {
  ...
  // 1. Use useEffect that watches query
  // 2. Set a 300ms timeout before calling searchArticles
  // 3. Clear timeout on cleanup to debounce
  // 4. Handle loading state and stale requests
